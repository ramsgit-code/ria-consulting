...
export const content = {
  es: {
    ...
    hero: {
      ...
      offering: [
        "Sistema de captación y cualificación de leads",
        "CRM en Go High Level a tu medida",
        "Automatización con IA: WhatsApp, Telegram, correo y redes",
        "Sistema de generación de propuestas comerciales",
      ],
    ...
    servicios: {
      ...
      items: [
        ...
        },
        {
          ...
          tagline: "Tu CRM en Go High Level, automatizado con IA de punta a punta.",
          problem:
          ...
          deliverables: [
            ...
            "Automatización con IA en WhatsApp y Telegram",
  ...
  en: {
    ...
    hero: {
      ...
      offering: [
        ...
        "AI automation: WhatsApp, Telegram, email and social",
        "Commercial proposal generation system",
      ],
    ...
    servicios: {
      ...
      items: [
        ...
        },
        {
          slug: "crm-automation",
          title: "CRM Automation",
          tagline: "Your Go High Level CRM, AI-automated end to end.",
          problem:
          ...
          deliverables: [
            ...
            "AI automation across WhatsApp and Telegram",
